...
class HeroProvider {
    ...
    async loadHeroes() {
        try {
            const response = await axios_1.default.get('https://www.dota2.com/datafeed/herolist?language=schinese');
...
function registerHeroTreeView(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('showDota2HeroDetails', async (hero) => {
        try {
...
class ItemProvider {
    ...
    async loadItems() {
        try {
            const response = await axios_1.default.get('https://www.dota2.com/datafeed/itemlist?language=schinese');
            const data = response.data.result.data;
            if (data && data.itemabilities) {
                this.items = data.itemabilities.filter((item) => item.name_loc !== "");
                this._onDidChangeTreeData.fire(undefined);
            }
        }
        catch (error) {
...
function registerItemTreeView(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('showDota2ItemDetails', async (item) => {
        try {
