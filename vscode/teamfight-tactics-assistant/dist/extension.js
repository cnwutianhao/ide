...
exports.registerChessTreeView = void 0;
...
class ChessProvider {
    ...
    async loadChesses() {
        try {
            const response = await axios_1.default.get('https://game.gtimg.cn/images/lol/act/img/tft/js/chess.js');
            const data = response.data;
            if (data && data.data) {
                this.chesses = data.data.map((chess) => ({
                    ...chess,
...
function registerChessTreeView(context) {
    const chessProvider = new ChessProvider();
    vscode.window.registerTreeDataProvider('tft_asst_chess', chessProvider);
    context.subscriptions.push(vscode.commands.registerCommand('showTftChessDetails', async (chess) => {
        const panel = vscode.window.createWebviewPanel('chessDetails', `英雄 - ${chess.title} ${chess.displayName}`, vscode.ViewColumn.One, {});
        panel.onDidDispose(() => {
...
exports.registerChessTreeView = registerChessTreeView;
...
const chessTreeView_1 = __webpack_require__(1);
function activate(context) {
    (0, chessTreeView_1.registerChessTreeView)(context);
}
