...
exports.registerHeroTreeView = void 0;
const vscode = __webpack_require__(2);
const axios_1 = __webpack_require__(3);
const iconv = __webpack_require__(43);
class HeroProvider {
    constructor() {
    ...
    async loadHeroes() {
        try {
            const response = await axios_1.default.get('https://pvp.qq.com/web201605/js/herolist.json');
...
function registerHeroTreeView(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('showHeroDetails', async (hero) => {
        try {
            const response = await axios_1.default.get(`https://pvp.qq.com/web201605/herodetail/m/${hero.ename}.html`, {
            ...
            const strippedHeroDetailsHtml = heroDetailsHtml
                ...
                .replace(/<a\b[^>]*>(.*?)<\/a>/gi, '');
            const panel = vscode.window.createWebviewPanel('heroDetails', `英雄 - ${hero.cname}`, vscode.ViewColumn.One, {});
...
exports.registerHeroTreeView = registerHeroTreeView;
...
var bomHandling = __webpack_require__(46),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(47); // Lazy load all encoding definitions.
...
iconv.enableStreamingAPI = function enableStreamingAPI(stream_module) {
    ...
    var streams = __webpack_require__(66)(stream_module);
...
var stream_module;
try {
    stream_module = __webpack_require__(7);
} catch (e) {}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.registerItemTreeView = void 0;
const vscode = __webpack_require__(2);
const axios_1 = __webpack_require__(3);
class ItemProvider {
    constructor() {
    ...
    async loadItems() {
        try {
            const response = await axios_1.default.get('https://pvp.qq.com/web201605/js/item.json');
            const data = response.data;
            if (Array.isArray(data)) {
                this.items = data;
                this._onDidChangeTreeData.fire(undefined);
    ...
    getTreeItem(element) {
        const treeItem = new vscode.TreeItem(`${element.item_name}`, vscode.TreeItemCollapsibleState.None);
...
function registerItemTreeView(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('showItemDetails', (item) => {
        const panel = vscode.window.createWebviewPanel('itemDetails', `装备 - ${item.item_name}`, vscode.ViewColumn.One, {});
        panel.webview.html = `
            <!DOCTYPE html>
            <html>
...
exports.registerItemTreeView = registerItemTreeView;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.registerRuneTreeView = void 0;
const vscode = __webpack_require__(2);
const axios_1 = __webpack_require__(3);
class RuneProvider {
    constructor() {
    ...
    async loadRunes() {
        try {
            const response = await axios_1.default.get('https://pvp.qq.com/web201605/js/ming.json');
            const data = response.data;
            if (Array.isArray(data)) {
                this.runes = data;
                this._onDidChangeTreeData.fire(undefined);
    ...
    getTreeItem(element) {
        const treeItem = new vscode.TreeItem(`${element.ming_name}`, vscode.TreeItemCollapsibleState.None);
...
function registerRuneTreeView(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('showRuneDetails', (rune) => {
        const panel = vscode.window.createWebviewPanel('runeDetails', `铭文 - ${rune.ming_name}`, vscode.ViewColumn.One, {});
        panel.webview.html = `
            <!DOCTYPE html>
            <html>
...
exports.registerRuneTreeView = registerRuneTreeView;
...
const heroTreeView_1 = __webpack_require__(1);
const itemTreeView_1 = __webpack_require__(67);
const runeTreeView_1 = __webpack_require__(68);
function activate(context) {
    (0, heroTreeView_1.registerHeroTreeView)(context);
    (0, itemTreeView_1.registerItemTreeView)(context);
    (0, runeTreeView_1.registerRuneTreeView)(context);
}
